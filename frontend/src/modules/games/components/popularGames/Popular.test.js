...
describe("Test <Popular_Games /> when isLoading is true and popular is empty", () => {
  let wrap;
  const props = {
    isLoading: true,
    popularGames: []
  ...
  beforeAll(() => {
    wrap = shallow(<Popular_Games {...props} />);
  });
...
describe("Test <Popular_Games /> when isLoading is true and popular is valid", () => {
  let wrap;
  const props = {
    isLoading: true,
    popularGames: [
...
describe("Test <Popular_Games /> when isLoading is false and popular is valid", () => {
  let wrap;
  const props = {
    isLoading: false,
    popularGames: [
